...
<body class="font-display bg-background-light dark:bg-background-dark text-[#181811] dark:text-white overflow-hidden relative selection:bg-primary selection:text-white">

    <!-- Background Decoration -->
    <div class="absolute inset-0 z-0">
        <div class="absolute inset-0 bg-[url('{{ asset('img/login-bg.png') }}')] bg-cover bg-center opacity-5"></div>
        <div class="absolute top-0 right-0 w-2/3 h-2/3 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary/10 via-transparent to-transparent"></div>
    ...
    <div class="relative z-10 min-h-screen flex flex-col items-center justify-center p-6">
        <div class="w-full max-w-lg">
            ...
            <div class="backdrop-blur-xl bg-surface-light/80 dark:bg-surface-dark/80 border border-white/20 dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden p-8 md:p-12 text-center relative">
                ...
                <!-- Error Code -->
                <h1 class="text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-primary to-orange-400 mb-2 leading-none selection:bg-transparent">
                    404
                </h1>
