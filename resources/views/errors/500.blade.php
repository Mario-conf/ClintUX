...
<body class="font-display bg-background-light dark:bg-background-dark text-[#181811] dark:text-white overflow-hidden relative selection:bg-red-500 selection:text-white">
    ...
    <!-- Background Decoration (Red Tint for Error) -->
    ...
    <div class="relative z-10 min-h-screen flex flex-col items-center justify-center p-6">
        <div class="w-full max-w-lg">
            ...
            <div class="backdrop-blur-xl bg-surface-light/80 dark:bg-surface-dark/80 border border-white/20 dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden p-8 md:p-12 text-center relative">
                ...
                <!-- Decoration Circle -->
                <div class="absolute -top-10 -right-10 w-32 h-32 bg-red-500/20 blur-3xl rounded-full pointer-events-none"></div>

                <!-- Error Code -->
                <h1 class="text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-red-500 to-orange-600 mb-2 leading-none selection:bg-transparent">
                    500
                </h1>
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-8 text-lg font-light leading-relaxed">
                    Something went wrong on our end. Our engineers are investigating the issue.
                </p>
