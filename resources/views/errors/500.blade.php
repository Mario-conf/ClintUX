    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg border border-gray-200 dark:border-gray-700 relative">
            ...
            <div class="relative z-10 text-center">
                <h1 class="text-9xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-600">
                    500
                </h1>
                ...
                <p class="mt-4 text-gray-600 dark:text-gray-400">
                    Something went wrong on our servers. We are working to fix this as soon as possible.
                </p>
